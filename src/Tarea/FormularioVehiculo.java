 ...
 */
public class FormularioVehiculo extends JFrame implements ActionListener {
    ...
    FormularioVehiculo() {
        ...
        setTitle("Formulario Vehiculo");
        setLocationRelativeTo(null);
        setResizable(false);

        //Jlabels
        //titulo
        eti1 = new JLabel("Formulario Vehiculo");
        eti1.setBounds(20, 30, 200, 20);
        
        //
        eti2 = new JLabel("Marca ");
        eti2.setBounds(40, 80, 180, 20);

        eti3 = new JLabel("Modelo ");
        eti3.setBounds(40, 120, 180, 20);
        
        eti4 = new JLabel("Año");
        eti4.setBounds(40, 160, 180, 20);
        
        eti5 = new JLabel("Color");
    ...
    public static void main(String[] args) {
        FormularioVehiculo f4 = new FormularioVehiculo();
