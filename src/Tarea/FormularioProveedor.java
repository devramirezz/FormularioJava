 ...
 */
public class FormularioProveedor extends JFrame implements ActionListener {
    ...
    FormularioProveedor() {
        ...
        //Jlabels
        //titulo
        eti1 = new JLabel("Formulario Proveedor");
        ...
        eti3 = new JLabel("Dirección ");
        eti3.setBounds(40, 120, 180, 20);
        
        eti4 = new JLabel("Teléfono");
        eti4.setBounds(40, 160, 180, 20);
        
        eti5 = new JLabel("Correo");
    ...
    public static void main(String[] args) {
        FormularioProveedor f2 = new FormularioProveedor();
